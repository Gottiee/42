...
/*   Updated: 2022/06/01 14:26:55 by eedy             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int handle_keypress_destroy(int keysym, t_data *data)
{
	mlx_destroy_window(data->mlx_ptr, data->win_ptr);
	data->win_ptr = NULL;
}
...
int	main(void)
{
	...
	mlx_hook(data.win_ptr, 17, StructureNotifyMask, &handle_keypress_destroy, &data);
